...
public class RecycleController implements Initializable {
    ...
    RedeemPage recycle = new RedeemPage();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        recycle.setPane(homePane, redeemPane, storePane, mePane);
        recycle.setImage(homeImage, redeemImage, storeImage, meImage);
        recycle.setLabel(homeLabel, redeemLabel, storeLabel, meLabel);
    }

    public void mouseClick(MouseEvent mouseEvent) throws IOException {
        recycle.mouseClick(mouseEvent);
    }

    public void mouseEnter(MouseEvent mouseEvent) throws IOException {
        recycle.mouseEnter(mouseEvent);
    }

    public void mouseExit(MouseEvent mouseEvent) throws IOException {
        recycle.mouseExit(mouseEvent);
    }
