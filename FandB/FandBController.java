...
public class FandBController implements Initializable{
    DirectoryController fandb = new DirectoryController();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fandb.setPane(homePane, redeemPane, storePane, mePane);
        fandb.setImage(homeImage, redeemImage, storeImage, meImage);
        fandb.setLabel(homeLabel, redeemLabel, storeLabel, meLabel);
    }

    public void mouseClick(MouseEvent mouseEvent) throws IOException {
        fandb.mouseClick(mouseEvent);
    }

    public void mouseEnter(MouseEvent mouseEvent) throws IOException {
        fandb.mouseEnter(mouseEvent);
    }

    public void mouseExit(MouseEvent mouseEvent) throws IOException {
        fandb.mouseExit(mouseEvent);
    }
